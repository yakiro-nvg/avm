...
static void basic_add(aasm_t* a, basic_test_ctx& t)
{
    ...
    REQUIRE(1 == aasm_emit(a, ai_brk()));
    REQUIRE(2 == aasm_emit(a, t.pop));
    REQUIRE(3 == aasm_emit(a, t.ldk));
    REQUIRE(4 == aasm_emit(a, ai_nil()));
    REQUIRE(5 == aasm_emit(a, ai_ldb(TRUE)));
    REQUIRE(6 == aasm_emit(a, ai_ldb(FALSE)));
    REQUIRE(7 == aasm_emit(a, ai_lsi(0xFEFA)));
    REQUIRE(8 == aasm_emit(a, t.llv));
    REQUIRE(9 == aasm_emit(a, t.slv));
    REQUIRE(10 == aasm_emit(a, t.imp));
    REQUIRE(11 == aasm_emit(a, t.cls));
    REQUIRE(12 == aasm_emit(a, t.jmp));
    REQUIRE(13 == aasm_emit(a, t.jin));
    REQUIRE(14 == aasm_emit(a, t.ivk));
    REQUIRE(15 == aasm_emit(a, ai_ret()));
    REQUIRE(16 == aasm_emit(a, ai_snd()));
    REQUIRE(17 == aasm_emit(a, t.rcv));
    REQUIRE(18 == aasm_emit(a, ai_rmv()));
    REQUIRE(19 == aasm_emit(a, ai_rwd()));
