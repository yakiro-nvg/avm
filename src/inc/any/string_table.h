...
function.
*/
ANY_API void astring_table_grow(astring_table_t* self, int32_t bytes);
...
*/
ANY_API int32_t astring_table_pack(astring_table_t* self);
...
AINLINE ahash_and_length_t ahash_and_length(const char* string)
{
